...
module.exports = {
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '𝛥𝐿𝛯𝛸 𝛲𝛪𝛫𝑈;𝛥𝐿𝛯𝛸 𝛲𝛪𝛫𝑈 𝛭𝐷',
  ...
  MEDIA_DATA: process.env.MEDIA_DATA|| 'ʟɪꜱᴛ ᴍᴇɴᴜ;𝛥𝐿𝛯𝛸 𝛲𝛪𝛫𝑈;https://f.uguu.se/EsfBAPSR.mp4',
  SUDO: process.env.SUDO || '918536881026,919153068527',
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || '',
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || '',
  BOT_INFO: process.env.BOT_INFO || '𝛥𝐿𝛯𝛸 𝛲𝛪𝛫𝑈;𝛥𝐿𝛯𝛸 𝛲𝛪𝛫𝑈;https://f.uguu.se/EsfBAPSR.mp4',
